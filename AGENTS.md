...
- ALWAYS run TypeScript checks using this exact pattern (never npx tsc directly — it fails on this machine):
  powershell.exe -Command "Set-Location 'C:\Users\manoj.kamatam\Documents\FinOps_Agent\packages\agent'; & node_modules\.bin\tsc.cmd --noEmit 2>&1"
